...
namespace TranslateService.api.microsofttranslator.com {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TranslateService.api.microsofttranslator.com.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public TranslateService.api.microsofttranslator.com.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="api.microsofttranslator.com.LanguageService")]
    public interface LanguageService {
        ...
        TranslateService.api.microsofttranslator.com.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, TranslateService.api.microsofttranslator.com.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, TranslateService.api.microsofttranslator.com.Translation[] translations, string from, string to, TranslateService.api.microsofttranslator.com.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        TranslateService.api.microsofttranslator.com.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, TranslateService.api.microsofttranslator.com.TranslateOptions options);
        ...
        TranslateService.api.microsofttranslator.com.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, TranslateService.api.microsofttranslator.com.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : TranslateService.api.microsofttranslator.com.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<TranslateService.api.microsofttranslator.com.LanguageService>, TranslateService.api.microsofttranslator.com.LanguageService {
        ...
        public TranslateService.api.microsofttranslator.com.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, TranslateService.api.microsofttranslator.com.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, TranslateService.api.microsofttranslator.com.Translation[] translations, string from, string to, TranslateService.api.microsofttranslator.com.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public TranslateService.api.microsofttranslator.com.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, TranslateService.api.microsofttranslator.com.TranslateOptions options) {
        ...
        public TranslateService.api.microsofttranslator.com.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, TranslateService.api.microsofttranslator.com.TranslateOptions options) {
