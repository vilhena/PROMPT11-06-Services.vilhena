...
namespace ChatServiceClientMVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        private void BuildCallback(string username)
        {
            var callback = new ChatClientImpl();

            var server = DuplexChannelFactory<IChatContractServer>.CreateChannel(
                callback,
